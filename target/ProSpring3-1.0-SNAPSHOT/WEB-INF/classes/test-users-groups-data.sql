...
insert into users(username, password, enabled, salt) values ('http://blahblahblah.myopenid.com/','unused',true,CAST(RAND()*1000000000 AS varchar));
insert into group_members(group_id, username) select id,'http://blahblahblah.myopenid.com/' from groups where group_name='Administrators';

-- Google
insert into users(username, password, enabled, salt) values ('https://www.google.com/accounts/o8/id?id=blahblahblah','unused',true,CAST(RAND()*1000000000 AS varchar));
insert into group_members(group_id, username) select id,'https://www.google.com/accounts/o8/id?id=blahblahblah' from groups where group_name='Administrators';
