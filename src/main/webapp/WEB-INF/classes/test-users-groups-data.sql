...
insert into users(username, password, enabled, salt) values ('http://eridan-sec.myopenid.com/','unused',true,CAST(RAND()*1000000000 AS varchar));
insert into group_members(group_id, username) select id,'http://eridan-sec.myopenid.com/' from groups where group_name='Administrators';
