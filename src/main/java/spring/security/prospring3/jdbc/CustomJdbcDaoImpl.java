...
import spring.security.prospring3.data.SaltedUser;
import spring.security.prospring3.security.IChangePassword;

/**
 * Extends the baseline Spring Security JdbcDaoImpl and implements change
...
//				password, username);
    ...
    protected List<UserDetails> loadUsersByUsername(String username) {
        return getJdbcTemplate().query("Select * from users where username = ?", new String[]{username}, new RowMapper<UserDetails>() {
